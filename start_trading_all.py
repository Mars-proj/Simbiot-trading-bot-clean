...
async def calculate_order_amount(exchange, symbol, volatility, avg_volume, min_notional=10.0, commission_rate=0.001):
    ...
    try:
        ...
        # Динамическая максимальная сумма на основе объёма торгов и волатильности
        ...
        logger.debug(f"Calculated order amount for {symbol}: {amount} (price: {current_price}, amount_usd: {amount * current_price})")
        return amount
    except Exception as e:
